...
INPUT_FILE = "cleaned_data/cleaned_GSE120575.txt"
OUTPUT_FILE = "geneformer_input_data/prepared_GSE120575.h5ad"
...
print(f"Data shape: {df.shape} (genes x cells) <- expect 12405 genes x 12244 cells")
